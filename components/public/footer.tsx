...
export function PublicFooter({ user }: PublicFooterProps) {
  ...
  return (
    <footer className="mt-16 border-t border-slate-200 bg-[#f5f5f7] text-slate-700">
      <div className="mx-auto max-w-[1440px] px-6 py-12 sm:px-8 lg:px-10 xl:px-12">
